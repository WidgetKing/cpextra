  ...
  function() {
    ...
    function PlaybarProxy() {
      ...
      this.managerPlaybarScrubbing = function() {
        ...
        if (that._scrubbing) {
          _extra.cssManager.removeClassFrom(
            sliderDIV.parentNode,
            "extra-mouse-disabled"
          );
      ...
      this.init = function() {
        ...
        // NOTE: This has now been replaced with the playbarCreator.createSlider hook. The resize event wasn't reliable enough.
        // _extra.w.addEventListener("resize", getPlaybarElements);

        if (_extra.captivate.playIcon) {
          _extra.captivate.playIcon.addEventListener(
            "click",
            getPlaybarElements
          );
        }
      ...
      this.ensureHookAdded = function() {
        var playbarCreator = _extra.captivate.getPlaybarCreator();

        if (!that.hasHook && playbarCreator)
          _extra.addHook(playbarCreator, "createSlider", getPlaybarElements);
      };
      ///////////////////////////////////////////////////////////////////////
      /////////////// PRIVATE FUNCTIONS
      ///////////////////////////////////////////////////////////////////////
      ...
      if (_extra.slideManager) {
        ...
        _extra.registerModule(
          ...
          ["slideManager_global", "cssManager"],
          function() {
