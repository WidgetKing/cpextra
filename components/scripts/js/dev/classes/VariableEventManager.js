 ...
 */
_extra.registerModule("VariableEventManager", ["VariableEventProxy"], function () {
    ...
    VariableEventManager.prototype.getListenerData = function(variableName, callback, remove) {

        var variableHandlerArray,
            variableData;
    ...
    VariableEventManager.prototype.hasListener = function (variableName, callback) {
        return this.getListenerData(variableName, callback) !== null;
    };

    VariableEventManager.prototype.addListener = function(variableName, callback) {
    ...
    VariableEventManager.prototype.removeListener = function(variableName, callback) {
        var listenerData = this.getListenerData(variableName, callback, true);
        if (listenerData) {

            this._softwareRemoveListener(variableName, listenerData.wrappedFunction);
