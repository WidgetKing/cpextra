...
_extra.registerModule(
  ...
  function() {
    ...
    var SUCCESS_CRITERIA = "success",
      ...
      commandDatas = {
        ...
        createScoreGetterSetterData: function(commandName, getter, setter) {
          var data = commandDatas.createGetterSetterData(
            commandName,
            getter,
            setter
          );
        ...
        createGetterData: function(commandName, getter) {
          var data = commandDatas.createBaseGetterSetterData(
            commandName,
            getter
          );
    ...
    _extra.variableManager.processCommandVariableRegistration({
      ...
      ////////////////////////////////
      ////////// Hide/Show
      Hide: commandDatas.createBasicSlideObjectData(
        "hide",
        _extra.slideObjects.hide
      ),

      Show: commandDatas.createBasicSlideObjectData(
        "show",
        _extra.slideObjects.show
      ),

      HideNonContentDivs: commandDatas.createBasicSlideObjectData(
        "hide",
        _extra.slideObjects.hideNonContentDivs
      ),

      ShowNonContentDivs: commandDatas.createBasicSlideObjectData(
        "show",
        _extra.slideObjects.showNonContentDivs
      ),

      ////////////////////////////////
      ////////// Interaction Enable/Disable
      Enable: commandDatas.createBasicSlideObjectData(
        "enable",
        _extra.slideObjects.enable
      ),

      Disable: commandDatas.createBasicSlideObjectData(
        "disable",
        _extra.slideObjects.disable
      ),

      ////////////////////////////////
      ////////// Mouse Enable/Disable

      EnableMouseEvents: commandDatas.createBasicSlideObjectData(
        "enableMouseEvents",
        _extra.slideObjects.enableForMouse
      ),

      DisableMouseEvents: commandDatas.createBasicSlideObjectData(
        "disableMouseEvents",
      ...
      PreventTabOut: commandDatas.createBasicSlideObjectData(
        "preventTabOut",
        _extra.focusManager.lockFocusTo
      ),

      AllowTabOut: commandDatas.createBasicSlideObjectData(
        "allowTabOut",
      ...
      ////////////////////////////////
      ////////// Round
      Round: commandDatas.createVariableCommandData(
        "round",
        _extra.variableManager.mathActions.round
      ),
      Floor: commandDatas.createVariableCommandData(
        "floor",
        _extra.variableManager.mathActions.floor
      ),
      Ceil: commandDatas.createVariableCommandData(
        "ceil",
        _extra.variableManager.mathActions.ceil
      ),
      RoundTo: {
        commandName: "roundTo",
        parameterHandler: handlers.sendParametersAsParameters,
      ...
      FlushStorage: {
        ...
        parseSetData: {
          ...
          alternateQueryHandler:
            _extra.variableManager.enactFunctionOnStorageVariables,
          exceptions: {
            invalidName: function(variableName) {
      ...
      /////////////// Event Listeners
      ///////////////////////////////////////////////////////////////////////
      AddEventListener: commandDatas.createEventListenerObjectData(
        "addEventListener",
        function(slideObject, event, interactiveObject, criteria) {
          _extra.eventManager.addEventListener(
            slideObject,
            event,
            interactiveObject,
            criteria
      ...
      RemoveEventListener: commandDatas.createEventListenerObjectData(
        "removeEventListener",
        function(slideObject, event, interactiveObject, criteria) {
          _extra.eventManager.removeEventListener(
            slideObject,
            event,
            interactiveObject,
            criteria
      ...
      /////////////// Set/Get Score
      ///////////////////////////////////////////////////////////////////////
      Score: commandDatas.createScoreGetterSetterData(
        "score",
        function(variableName, slideObjectName) {
          // Get
        ...
        function(slideObjectName, number) {
          // Set
      ...
      /////////////// MaxScore
      ///////////////////////////////////////////////////////////////////////
      MaxScore: commandDatas.createGetterData("maxScore", function(
        variableName,
        slideObjectName
      ) {
        var slideObject = _extra.quizManager.getSlideObjectQuestionData(
          slideObjectName
        );
      ...
      /////////////// X and Y
      ///////////////////////////////////////////////////////////////////////
      PosX: commandDatas.createGetterSetterData(
        "posX",
        function(variableName, slideObject) {
          // Get
      ...
      PosY: commandDatas.createGetterSetterData(
        "posY",
        function(variableName, slideObject) {
          // Get
      ...
      /////////////// Width and Height
      ///////////////////////////////////////////////////////////////////////
      Width: commandDatas.createGetterData("width", function(
        variableName,
        slideObject
      ) {
        _extra.variableManager.setVariableValue(
      ...
      Height: commandDatas.createGetterData("height", function(
        variableName,
        slideObject
      ) {
        _extra.variableManager.setVariableValue(
