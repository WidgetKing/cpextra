...
_extra.registerModule(
  "parameterParseSets",
  ["parameterParser", "variableManager"],
  function() {
    "use strict";
    ...
    var SUCCESS_CRITERIA = "success",
      ...
      runException = function(p) {
        // p: Stands for Parameters

        // Have a method to handle this exception
        if (
          p.data.exceptions &&
          p.data.exceptions.hasOwnProperty(p.exceptionName)
        ) {
    ...
    _extra.variableManager.parseSets = {
        ...
        CD: {
            ...
            function entryPoint() {
              ...
              if (p.parseResult.isSlideObject) {
                ...
                if (p.noQueries) {
                  ...
                  _extra.slideObjects.enactFunctionOnSlideObjects(
                    p.parseResult.value,
            ...
            function entryPoint() {
              ...
              if (p.parseResult.isVariable) {
                ...
                if (p.alternateQueryHandler) {
                  ...
                  _extra.variableManager.enactFunctionOnVariables(
                    p.parseResult.value,
                    p.output
                  );
                }
          ...
          SLR: function(p) {
            ...
            function entryPoint() {
              ...
              if (!canOutputSlide(p.parseResult.value)) {
                ...
                if (p.parseResult.isNumber) {
                  ...
                  _extra.slideManager.enactFunctionOnSlides(
                    p.parseResult.value,
                    function(name) {
                  ...
                  if (
                    p.parseResult.value.toLowerCase &&
            ...
            function canOutputSlide(name) {
              var slideDetails = _extra.slideManager.getSlideIndexFromName(
                name
              );
            ...
            function parseSlideIdentifier(identifier) {
              if (_extra.w.isNaN(identifier)) {
                // Is a slide name

                var details = _extra.slideManager.getSlideIndexFromName(
                  identifier
                );
      ...
      MP: {
        ...
        ///////////////////////////////////////////////////////////////////////
        /////////////// Interactive Object + String + Criteria
        ///////////////////////////////////////////////////////////////////////

        STR_INT_CRI: function(p) {
          var result = {
          ...
          function entryPoint() {
            validateData();
            result.string = getSingleParameter(p.STR, parseSets.SP.CD.STR);
          ...
          function getActionData() {
            var output = p.output;
            runTestWithFakeOutput(p, parseSets.MP.INT_CRI, function(
              interactiveObject,
              criteria
            ) {
              output(result.string, interactiveObject, criteria);
            });
          }
        ...
        VR_NR1_NR2: function(p) {
          ...
          function applyToVariables(number2) {
            ...
            var output = p.output;
            runTestWithFakeOutput(p, parseSets.MP.VR_NR, function(
              variableName,
              number1
            ) {
        ...
        SOR_NR: function(p) {
          ...
          function isGetter() {
            ...
            if (
              p2.isSlideObject ||
              (p2.isVariable && p2.variable.isSlideObject)
            ) {
